...
import { BaseEntity, BaseEntityRep } from "src/common/entities/base";
import { SexEnum } from "src/common/enum/index";
@Entity("sys_user", { comment: "用户信息表" })
export class UserEntity extends BaseEntityRep {
    ...
    //0男 1女 2未知
    @Column({ type: "enum", enum: SexEnum, name: "sex", default: SexEnum.MAN, comment: "性别" })
    public sex: number;
